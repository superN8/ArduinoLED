//==Version B==
//-Setup to intialize Rainbow State
//-LED Values adjusted by Step Size
...
void loop()
{
    for(int i = 0; i < stripLength; i++)
    {
        ...
        if(rainState <= 255)
        {
			ledStripA[i][1]+=stepSize;
        }
        else if(rainState <= 510)
        {
			ledStripA[i][0]-=stepSize;
        }
        else if(rainState <= 765)
        {
			ledStripA[i][2]+=stepSize;
        }
        else if(rainState <= 1020)
        {
            ledStripA[i][1]-=stepSize;
        }
        else if(rainState <= 1275)
        {
            ledStripA[i][0]+=stepSize;
        }
        else
